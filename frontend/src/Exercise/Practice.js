...
function Practice({ BACKEND_API_HOSTNAME }) {
    ...
    const exercise_kinds = [
        { number: 1, component_name: 'MatchPictureToWritten_form', component: MatchPictureToWritten_form },
        { number: 2, component_name: 'MatchPictureToWritten_form', component: MatchPictureToWritten_form },
        { number: 3, component_name: 'MatchWritten_formToEnglish_equivalent', component: MatchWritten_formToEnglish_equivalent },
        { number: 4, component_name: 'MatchSoundToWritten_form', component: MatchSoundToWritten_form },
        { number: 5, component_name: 'MatchPictureToWritten_form', component: MatchPictureToWritten_form },
        { number: 6, component_name: 'MatchPictureToWritten_form', component: MatchPictureToWritten_form },
        { number: 7, component_name: 'MatchWritten_formToEnglish_equivalent', component: MatchWritten_formToEnglish_equivalent }
    ];
